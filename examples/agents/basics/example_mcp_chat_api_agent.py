...
settings.top_p = 1.0
# Example: Connect to a MCP server
server_params = StdioServerParameters(
    command="H:\\MaxDev42\\.venv3\\Scripts\\python.exe",
    args=["H:\\MaxDev42\\ToolAgentsDev\\examples\\personal_mcp_tools.py"]
)

# Create the adapter
adapter = MCPAdapter(server_params)

# Get all available tools, resources, and prompts as FunctionTool instances
tools_dict = adapter.get_tools()
tools = []
